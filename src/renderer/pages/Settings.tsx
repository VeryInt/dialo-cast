                    ...
                    <div className="gap-6 flex flex-col">
                        <div className="flex flex-col gap-1">
                            <div className="flex justify-between items-center">
                                ...
                                <span
                                    ...
                                    className="flex items-center cursor-pointer text-blue-600 hover:text-blue-800 text-sm"
                                >
                                    获取API <ExternalLink className="ml-2 w-4 h-4" />
                                </span>
                            </div>
                            <Input
                                id="api-key"
                        ...
                        <div className="flex flex-col gap-1">
                            <div className="flex justify-between items-center">
                                ...
                                <span
                                    onClick={() =>
                                        handleOpenLink('https://platform.minimaxi.com/user-center/basic-information')
                                    }
                                    className="flex items-center cursor-pointer text-blue-600 hover:text-blue-800 text-sm"
                                >
                                    查看GroupID <ExternalLink className="ml-2 w-4 h-4" />
                                </span>
                            </div>
                            <Input
                                id="group-id"
